...
//        var_dump($this->db->get_compiled_select($this->table));
    ...
    public function get_join_extra($join_table = null, array $fields = null, array $where = null, array $condition = null, $type = null, $extra= null,$group = null,  $limit = null, $start = null)
    {
        $this->db->from($this->table);
        if (!empty($extra)) {
